...
DOGRON: Non sentite un po' la tristezza? Siamo già a metà dello show e a me non mi va mica di farvi andare via, nuuuuuuuuuuuu!
DOGRON: Ma la Suprema Chihuahua e il Gran Consiglio dei Carlini, nella loro saggezza loro sanno che è importante trovare la padroncina perfetta, no, la personcina perfetta per il ristorante su Satuuuuuurno!
