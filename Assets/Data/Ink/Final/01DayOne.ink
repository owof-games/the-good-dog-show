...
{new_mode_plus == "false": DOGRON: Tradotto nelle regole del programma: potete parlare con un massimo di {abilities has PNGParliExtra: {base_dialogue_loops+1}|{base_dialogue_loops}} persone!}
